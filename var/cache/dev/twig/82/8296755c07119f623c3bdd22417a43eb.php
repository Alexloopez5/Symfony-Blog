...
class __TwigTemplate_ccdd32c5c29916b33eb1d26a04af27a5 extends Template
{
    ...
    <div class=\"container\">
        ...
        echo "
            ";
        // line 11
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 11, $this->source); })()), "email", [], "any", false, false, false, 11), 'row', ["attr" => ["class" => "form-control"]]);
        echo "
            ";
        // line 12
...
";
    ...
    {
        return array (  117 => 19,  111 => 16,  108 => 15,  106 => 13,  102 => 12,  98 => 11,  94 => 10,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "registration/register.html.twig", "/home/alumno/DWES/symfony-blog-esqueleto/templates/registration/register.html.twig");
    }
}
